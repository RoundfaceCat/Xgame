...
execute_process(
  COMMAND "D:/Git/cmd/git.exe" --git-dir=.git show-ref "v3.0.0"
  WORKING_DIRECTORY "D:/Xgame/Xgame/build-verify/_deps/sheenbidi-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Xgame/Xgame/build-verify/_deps/sheenbidi-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Xgame/Xgame/build-verify/_deps/sheenbidi-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
